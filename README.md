...
> 
> 🔗 *[Read the complete Technical & Socket Contract Documentation here](./ft_transcendence/README.md)*
...
| [📁 ft_printf](./ft_printf/README.md) | <img src="https://img.shields.io/badge/125%20%2F%20100-Outstanding-2EA043?style=flat-square&logo=42&logoColor=white" alt="125/100" /> | `C` `Variadic_FX` `I/O` | Recreated the standard C `printf` function from scratch, managing variadic arguments (`stdarg.h`) and standard output conversions. |
| [📁 libft](./libft/README.md) | <img src="https://img.shields.io/badge/125%20%2F%20100-Outstanding-2EA043?style=flat-square&logo=42&logoColor=white" alt="125/100" /> | `C` `Data_Structures` | Developed a fully compliant custom implementation of the standard C library, including memory operations, string manipulation, and linked list handling. |
