...
const userService = {
    ...
    searchUsers: async (query: string): Promise<UserProfile[]> => {
        // Asumiendo que Kevin ha implementado un filtro por búsqueda. 
        // Si la API devuelve un listado paginado, normalmente los datos vienen dentro de response.data.data
